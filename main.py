...
def admin_dashboard():
    ...
    <head>
        ...
        <style>
            ...
            .dashboard-title .username-highlight {{ color: {rank_color}; background: none; -webkit-background-clip: unset; -webkit-text-fill-color: {rank_color}; background-clip: unset; font-weight: 800; text-shadow: 0 2px 12px {rank_color}8c; }}
